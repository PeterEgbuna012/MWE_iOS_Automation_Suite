...
async function executeAtom(atom, args = [], frames = []) {
    ...
    this.log.debug(`Received result for atom '${atom}' execution: ${support_1.util.truncateString((0, utils_1.simpleStringify)(value), utils_1.RESPONSE_LOG_LENGTH)}`);
    return value;
}
/**
...
override) {
    ...
    this.log.debug(`Sending javascript command: '${support_1.util.truncateString(command, 50)}'`);
