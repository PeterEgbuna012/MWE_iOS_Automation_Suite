...
async function onPageChange(err, appIdKey, pageDict) {
    ...
    if ((0, property_accessors_1.getAppDict)(this)[appIdKey]) {
        ...
        if (previousPages && (0, utils_1.deepEqual)(previousPages, currentPages)) {
...
async function onConnectedApplicationList(err, apps) {
    ...
    Object.assign((0, property_accessors_1.getAppDict)(this), (0, utils_1.defaults)((0, property_accessors_1.getAppDict)(this), newDict));
}
/**
...
function getDebuggerAppKey(bundleId) {
    let appId;
    for (const [key, data] of Object.entries((0, property_accessors_1.getAppDict)(this))) {
