...
function isPageLoadingCompleted(readyState) {
    const pageLoadStrategy = ((0, property_accessors_1.getPageLoadStartegy)(this) ?? '').toLowerCase();
...
async function waitForDom(startPageLoadTimer) {
    ...
    (0, property_accessors_1.setPageLoadDelay)(this, (0, asyncbox_1.sleep)({ ms: readinessTimeoutMs, cancelError: new utils_1.DelayCancellation() }));
    const pageReadinessPromise = (async () => {
        ...
        while (isPageLoading) {
            ...
            await (0, asyncbox_1.sleep)(intervalMs);
    ...
    try {
        ...
        isPageLoading = false;
        (0, property_accessors_1.setPageLoading)(this, false);
        (0, property_accessors_1.setPageLoadDelay)(this, undefined);
    }
}
/**
...
async function checkPageIsReady(timeoutMs) {
    ...
    try {
        const readyState = await (0, asyncbox_1.withTimeout)(this.execute(readyCmd), actualTimeoutMs, new utils_1.TimeoutError(`Operation timed out after ${actualTimeoutMs}ms`));
...
async function navToUrl(url) {
    ...
    const pageReadinessPromise = new Promise((resolve) => {
