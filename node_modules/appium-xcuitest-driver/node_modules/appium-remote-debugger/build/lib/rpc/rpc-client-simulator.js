    ...
    async connect() {
        ...
        if (this.socketPath) {
            if (this.messageProxy) {
                ...
                this.socket = node_net_1.default.connect(this.messageProxy);
                ...
                this.socket = node_net_1.default.connect(this.socketPath);
            }
        }
        else {
            if (this.messageProxy) {
    ...
    async sendMessage(cmd) {
        ...
        return await new Promise((resolve, reject) => {
            ...
            if (!this.socket || !this.service) {
                return reject(new Error('The RPC client is not connected. Have you called `connect()` before sending a message?'));
            }
