...
exports.ImageMounter = exports.MOBILE_IMAGE_MOUNTER_SERVICE_NAME = void 0;
const base_service_1 = require("../base-service");
const support_1 = require("@appium/support");
const logger_1 = require("../logger");
const { lstat, readFile, createReadStream } = support_1.fs;
exports.MOBILE_IMAGE_MOUNTER_SERVICE_NAME = 'com.apple.mobile.mobile_image_mounter';
...
class ImageMounter extends base_service_1.BaseServicePlist {
    ...
    async mount(imageFilePath, imageSignatureFilePath, imageType = 'Developer') {
        ...
        if (checkIfError(receiveBytesResult).Status !== 'ReceiveBytesAck') {
            const errMsg = `Unexpected return from ${exports.MOBILE_IMAGE_MOUNTER_SERVICE_NAME} on sending ReceiveBytes`;
        ...
        if (checkIfError(pushImageResult).Status !== 'Complete') {
            const errMsg = `Unexpected return from ${exports.MOBILE_IMAGE_MOUNTER_SERVICE_NAME} on pushing image file`;
