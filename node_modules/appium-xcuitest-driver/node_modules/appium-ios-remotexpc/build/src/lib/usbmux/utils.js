 ...
 */
export function prioritizeUsbOverNetworkForDuplicateUdids(devices) {
    const result = [...devices];
    const indicesByUdid = new Map();
...
function stableSortByWirelessRank(items) {
    return items
