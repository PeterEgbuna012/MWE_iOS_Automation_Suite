...
export class Opack2 {
    ...
    static decode(data, offset) {
        ...
        if (marker >= constants.OPACK2_SMALL_INT_OFFSET &&
            marker <=
        ...
        if (marker >= constants.OPACK2_SMALL_STRING_BASE &&
            marker <=
        ...
        if (marker >= constants.OPACK2_SMALL_BYTES_BASE &&
            marker <=
        ...
        if (marker >= constants.OPACK2_SMALL_ARRAY_BASE &&
        ...
        if (marker >= constants.OPACK2_SMALL_DICT_BASE &&
    ...
    static decodeBytes(data, offset, length) {
    ...
    static decodeFixedArray(data, offset, length) {
        const result = [];
    ...
    static decodeFixedDict(data, offset, length) {
        const result = {};
        let currentOffset = offset;
        for (let i = 0; i < length; i++) {
    ...
    static decodeLength(data, offset, byteLength) {
    ...
    static decodeString(data, offset, length) {
        this.ensureAvailable(data, offset, length);
        return {
    ...
    static decodeVariableArray(data, offset) {
        const result = [];
        let currentOffset = offset;
        while (true) {
            const decoded = this.decode(data, currentOffset);
    ...
    static decodeVariableDict(data, offset) {
        const result = {};
        let currentOffset = offset;
        while (true) {
            const key = this.decode(data, currentOffset);
    ...
    static ensureAvailable(data, offset, length) {
...
//# sourceMappingURL=opack2.js.map