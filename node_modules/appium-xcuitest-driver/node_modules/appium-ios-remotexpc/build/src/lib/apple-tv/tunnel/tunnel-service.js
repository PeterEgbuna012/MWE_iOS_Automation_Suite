...
import { DEFAULT_PAIRING_CONFIG, REMOTE_PAIRING_DISCOVERY_DOMAIN, REMOTE_PAIRING_VERIFIED_DISCOVERY_SERVICE_TYPE, } from '../constants.js';
...
export class AppleTVTunnelService {
    ...
    async startTunnel(deviceId, specificDeviceIdentifier, options = {}) {
     ...
     */
    selectDevicesToProcess(devices, specificDeviceIdentifier, pairRecordIds = []) {
    ...
    resolveTunnelIdentifier(pairRecord, device) {
    ...
    withTunnelIdentifier(device, pairRecord) {
        return {
            ...device,
...
function connectToListenerPort(hostname, port) {
