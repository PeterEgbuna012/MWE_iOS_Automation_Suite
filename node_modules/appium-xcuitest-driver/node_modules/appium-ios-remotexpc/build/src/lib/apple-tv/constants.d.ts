 ...
 */
export declare const REMOTE_PAIRING_MANUAL_DISCOVERY_SERVICE_TYPE = "_remotepairing-manual-pairing._tcp";
/**
 ...
 */
export declare const REMOTE_PAIRING_VERIFIED_DISCOVERY_SERVICE_TYPE = "_remotepairing._tcp";
export declare const REMOTE_PAIRING_DISCOVERY_DOMAIN = "local";
