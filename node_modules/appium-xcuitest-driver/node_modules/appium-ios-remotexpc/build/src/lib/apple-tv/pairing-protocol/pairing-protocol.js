...
import { Opack2, createEd25519Signature, decryptChaCha20Poly1305, encryptChaCha20Poly1305, generateEd25519KeyPair, hkdf, } from '../encryption/index.js';
...
export class PairingProtocol {
    ...
    extractRemotePairingUdid(decryptedTLV) {
     ...
     */
    async createPairingResult(device, ltpk, ltsk, remotePairingUdid) {
    ...
    resolvePairingDeviceId(device, remotePairingUdid) {
        if (remotePairingUdid) {
        ...
        throw new PairingError('Apple TV pairing did not provide remotepairing_udid and no macOS devicectl fallback is available', 'REMOTE_PAIRING_UDID_MISSING');
    }
}
