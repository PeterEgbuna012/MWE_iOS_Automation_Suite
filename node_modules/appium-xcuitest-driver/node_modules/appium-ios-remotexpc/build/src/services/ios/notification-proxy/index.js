...
class NotificationProxyService extends BaseService {
    ...
    constructor(udid, timeout = 10000) {
        super(udid);
    ...
    async connectToNotificationProxyService() {
        ...
        this._conn = await this.startLockdownService(NotificationProxyService.RSD_SERVICE_NAME, { createConnectionTimeout: this.timeout });
        return this._conn;
    }
