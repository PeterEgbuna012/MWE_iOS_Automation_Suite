 ...
 */
export function encodeHeaderExplicit(op, packetNum, entireLen, thisLen) {
 ...
 */
export function encodeHeader(op, packetNum, payloadLen) {
...
const FATAL_SOCKETS = new WeakSet();
/**
 ...
 */
export function fatalizeAfcSocket(socket, error) {
 ...
 */
export async function readAfcHeader(socket, timeoutMs = AFC_OPERATION_TIMEOUT_MS) {
 ...
 */
export async function readAfcResponse(socket, timeoutMs = AFC_OPERATION_TIMEOUT_MS) {
 ...
 */
export async function writeBufferToSocket(socket, data) {
 ...
 */
export async function sendAfcPacket(socket, op, packetNum, headerPayload = Buffer.alloc(0), content = Buffer.alloc(0)) {
 ...
 */
export async function sendOnePlist(socket, request) {
 ...
 */
export function cleanupServiceSocket(socket, error) {
    cleanupSocketState(socket, error);
}
function assertSocketReadable(socket) {
