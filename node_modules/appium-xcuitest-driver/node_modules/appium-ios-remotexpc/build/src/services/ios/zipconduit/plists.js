 ...
 */
export function createInitTransfer(fileName) {
 ...
 */
export function createMetaInfPlist(numFiles, totalBytes) {
    return {
 ...
 */
export function evaluateProgress(progressUpdate) {
    ...
    const progress = installProgressDict;
    ...
    if (errorMessage) {
        ...
        if (errorMessage === SIGNING_ERROR) {
            throw new Error(`App is not properly signed for this device. original error: '${errorMessage}' errorDescription:'${description}'`);
        }
...
//# sourceMappingURL=plists.js.map