 ...
 */
function throwIfNSErrorReply(result, context) {
    ...
    if (objects) {
        ...
        if (hasErr) {
            const msg = objects.find((o) => typeof o === 'string' && o.length > MIN_NSERROR_DESCRIPTION_LEN) ?? 'NSError from testmanagerd';
 ...
 */
async function deleteAttachmentsOnChannel(connection, channelCode, uuids) {
    if (!uuids.length) {
...
//# sourceMappingURL=xctest-attachment.js.map