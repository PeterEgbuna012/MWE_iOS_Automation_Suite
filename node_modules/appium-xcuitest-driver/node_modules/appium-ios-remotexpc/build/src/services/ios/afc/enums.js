...
(function (AfcOpcode) {
    ...
    AfcOpcode[AfcOpcode["READ_FILE"] = 4] = "READ_FILE";
    AfcOpcode[AfcOpcode["WRITE_FILE"] = 5] = "WRITE_FILE";
    AfcOpcode[AfcOpcode["WRITE_PART"] = 6] = "WRITE_PART";
    AfcOpcode[AfcOpcode["TRUNCATE"] = 7] = "TRUNCATE";
    ...
    AfcOpcode[AfcOpcode["WRITE_FILE_ATOM"] = 12] = "WRITE_FILE_ATOM";
    AfcOpcode[AfcOpcode["FILE_OPEN"] = 13] = "FILE_OPEN";
    AfcOpcode[AfcOpcode["FILE_OPEN_RES"] = 14] = "FILE_OPEN_RES";
    AfcOpcode[AfcOpcode["READ"] = 15] = "READ";
    AfcOpcode[AfcOpcode["WRITE"] = 16] = "WRITE";
    AfcOpcode[AfcOpcode["FILE_SEEK"] = 17] = "FILE_SEEK";
    AfcOpcode[AfcOpcode["FILE_TELL"] = 18] = "FILE_TELL";
    AfcOpcode[AfcOpcode["FILE_TELL_RES"] = 19] = "FILE_TELL_RES";
    AfcOpcode[AfcOpcode["FILE_CLOSE"] = 20] = "FILE_CLOSE";
    AfcOpcode[AfcOpcode["FILE_SET_SIZE"] = 21] = "FILE_SET_SIZE";
    AfcOpcode[AfcOpcode["GET_CON_INFO"] = 22] = "GET_CON_INFO";
    AfcOpcode[AfcOpcode["SET_CON_OPTIONS"] = 23] = "SET_CON_OPTIONS";
    AfcOpcode[AfcOpcode["RENAME_PATH"] = 24] = "RENAME_PATH";
    AfcOpcode[AfcOpcode["SET_FS_BS"] = 25] = "SET_FS_BS";
    AfcOpcode[AfcOpcode["SET_SOCKET_BS"] = 26] = "SET_SOCKET_BS";
    AfcOpcode[AfcOpcode["FILE_LOCK"] = 27] = "FILE_LOCK";
    AfcOpcode[AfcOpcode["MAKE_LINK"] = 28] = "MAKE_LINK";
    AfcOpcode[AfcOpcode["SET_FILE_TIME"] = 30] = "SET_FILE_TIME";
})(AfcOpcode || (AfcOpcode = {}));
export var AfcError;
(function (AfcError) {
