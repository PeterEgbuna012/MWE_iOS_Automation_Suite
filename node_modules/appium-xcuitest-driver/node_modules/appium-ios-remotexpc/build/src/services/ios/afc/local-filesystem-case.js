...
const caseSensitivityByDevice = new Map();
/**
 ...
 */
export async function isCaseSensitiveDirectory(dir) {
 ...
 */
export function parseDiskutilInfoPlist(info) {
    ...
    if (filesystemName?.includes('HFS') &&
...
async function getDarwinCaseSensitivity(dir) {
...
function getExplicitCaseSensitiveField(info) {
...
//# sourceMappingURL=local-filesystem-case.js.map