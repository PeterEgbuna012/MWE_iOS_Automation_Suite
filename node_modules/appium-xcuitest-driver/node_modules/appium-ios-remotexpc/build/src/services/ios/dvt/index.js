...
export class DVTSecureSocketProxyService extends BaseService {
     ...
     */
    async recvPlist(channel = DVTSecureSocketProxyService.BROADCAST_CHANNEL, signal) {
     ...
     */
    async recvMessage(channel = DVTSecureSocketProxyService.BROADCAST_CHANNEL, signal) {
    ...
    async close() {
        ...
        if (activeCodes.length > 0) {
            ...
            try {
                await this.sendMessage(DVTSecureSocketProxyService.BROADCAST_CHANNEL, '_channelCanceled:', { args, expectsReply: false });
            }
            catch (error) {
