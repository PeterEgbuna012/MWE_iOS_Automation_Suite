 ...
 */
export declare const getPath: ((timeout?: number) => Promise<string>) & {
 ...
 * @throws {Error} If the SDK version number cannot be determined
 */
export declare const getMaxIOSSDK: ((retries?: number, timeout?: number) => Promise<string | null>) & {
 ...
 * @throws {Error} If the SDK version number cannot be determined
 */
export declare const getMaxTVOSSDK: ((retries?: number, timeout?: number) => Promise<string>) & {
    cache: Map<unknown, Promise<string>>;
};
