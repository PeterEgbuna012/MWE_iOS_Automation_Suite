...
async function mobileInstallCertificate(content, commonName, isRoot = true) {
    ...
    try {
        ...
        try {
            ...
            throw new Error(`Cannot store the generated config as '${configPath}'. ` + `Original error: ${err.message}`, { cause: err });
        }
        try {
...
async function mobileRemoveCertificate(name) {
    (0, helpers_1.requireRealDevice)(this, 'Removing certificate');
...
async function mobileListCertificates() {
    (0, helpers_1.requireRealDevice)(this, 'Listing certificates');
...
async function installCustomSslCertFromCapability() {
    ...
    (0, helpers_1.requireRealDevice)(this, 'install customSSLCert capability');
    await withCertificateClient(this, async (client) => {
...
async function withCertificateClient(driver, operation) {
    ...
    try {
        ...
        client = await certificate_client_1.CertificateClient.create(driver.opts.udid, driver.log, driver.remoteXPCFacade);
