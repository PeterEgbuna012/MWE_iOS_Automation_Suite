...
const app_install_1 = require("./app-install");
...
async function mobileKillApp(bundleId) {
    return await (0, helpers_1.requireRealDevice)(this, 'Killing app').terminateApp(bundleId);
}
/**
...
async function mobileListApps(applicationType = 'User', returnAttributes) {
    const device = (0, helpers_1.requireRealDevice)(this, 'Listing apps');
    const client = await installation_proxy_client_1.InstallationProxyClient.create(device.udid, this.remoteXPCFacade);
    try {
