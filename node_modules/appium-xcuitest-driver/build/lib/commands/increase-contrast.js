...
async function mobileSetIncreaseContrast(increaseContrast) {
    if (!INCREASE_CONTRAST_CONFIG.includes(String(increaseContrast).toLowerCase())) {
    ...
    await (0, helpers_1.requireSimulator)(this, 'Setting increase contrast').setIncreaseContrast(increaseContrast);
}
/**
...
async function mobileGetIncreaseContrast() {
    return (await (0, helpers_1.requireSimulator)(this, 'Getting increase contrast').getIncreaseContrast());
}
