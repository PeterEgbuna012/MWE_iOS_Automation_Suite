...
async function mobileEnrollBiometric(isEnabled = true) {
    await (0, helpers_1.requireSimulator)(this, 'Biometric enrollment').enrollBiometric(isEnabled);
}
/**
...
async function mobileSendBiometricMatch(type = 'touchId', match = true) {
    await (0, helpers_1.requireSimulator)(this, 'Sending biometric match').sendBiometricMatch(match, type);
}
/**
...
async function mobileIsBiometricEnrolled() {
    return await (0, helpers_1.requireSimulator)(this, 'Checking biometric enrollment').isBiometricEnrolled();
}
