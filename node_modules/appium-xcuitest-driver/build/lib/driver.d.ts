...
export declare class XCUITestDriver extends BaseDriver<XCUITestDriverConstraints, StringRecord> implements ExternalDriver<XCUITestDriverConstraints, FullContext | string, StringRecord> {
    ...
    static executeMethodMap: {
        ...
        readonly 'mobile: enableVoiceOver': {
            readonly command: "mobileEnableVoiceOver";
        };
        readonly 'mobile: disableVoiceOver': {
            readonly command: "mobileDisableVoiceOver";
        };
        readonly 'mobile: isVoiceOverEnabled': {
            readonly command: "mobileIsVoiceOverEnabled";
        };
        readonly 'mobile: voiceOverMove': {
            readonly command: "mobileVoiceOverMove";
            readonly params: {
                readonly required: readonly ["direction"];
            };
        };
        readonly 'mobile: voiceOverCurrentSpeech': {
            readonly command: "mobileVoiceOverCurrentSpeech";
        };
    ...
    mobileEnableVoiceOver: typeof voiceOverCommands.mobileEnableVoiceOver;
    mobileDisableVoiceOver: typeof voiceOverCommands.mobileDisableVoiceOver;
    mobileIsVoiceOverEnabled: typeof voiceOverCommands.mobileIsVoiceOverEnabled;
    mobileVoiceOverMove: typeof voiceOverCommands.mobileVoiceOverMove;
    mobileVoiceOverCurrentSpeech: typeof voiceOverCommands.mobileVoiceOverCurrentSpeech;
    ...
    mobileStartScreenRecording: typeof recordScreenCommands.mobileStartScreenRecording;
    mobileStopScreenRecording: typeof recordScreenCommands.mobileStopScreenRecording;
    ...
    startWda: typeof start;
    /**
     * @deprecated This method should be made protected/private.
     */
    startWdaSession: typeof startWdaSession;
    stopWda: typeof stop;
    ...
    private getOrCreateRemoteXPCFacade;
}
