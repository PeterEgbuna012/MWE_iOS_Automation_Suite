...
async function getExistingSim() {
    ...
    const simctl = new node_simctl_1.Simctl({ devicesSetPath });
    let devicesMap;
    if (udid && String(udid).toLowerCase() !== constants_1.UDID_AUTO) {
...
async function shutdownOtherSimulators() {
    ...
    if ((0, utils_1.isEmpty)(otherBootedDevices)) {
...
async function setSafariPrefs() {
    const prefs = (0, helpers_1.buildSafariPreferences)(this.opts);
    if ((0, utils_1.isEmpty)(prefs)) {
        return false;
    }
...
async function setLocalizationPrefs() {
    ...
    if ((0, utils_1.isEmpty)(l10nConfig)) {
        return false;
    }
