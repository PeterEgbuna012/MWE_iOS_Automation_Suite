...
class SessionClaimHandler {
    getIpc;
    static CLAIMED_TOPIC = 'xcuitest:sessionUdidClaimed';
    static CONTENDED_TOPIC = 'xcuitest:sessionUdidContended';
    static RELEASED_TOPIC = 'xcuitest:sessionUdidReleased';
